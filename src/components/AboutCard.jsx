...
import docotorimg from "../assets/doctorimage.png";
    ...
    <div className="flex flex-col justify-center items-center md:flex-col lg:flex-row bg-gray-200 px-6 py-20 md:px-30">
      ...
      <div className="w-full lg:w-[50%]">
        ...
        <div className="pt-4 w-full flex justify-center">
          <Link
            to="about-doctor"
            className="w-80 text-center rounded-lg bg-blue-800 shadow-md hover:shadow-xl hover:opacity-95 text-white py-2 px-8"
          >
